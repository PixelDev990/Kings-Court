...
namespace KingsCourt
{
    ...
    public class KingsCourtPlugin : BasePlugin
    {
        ...
        public static CustomOptionHeader KingsCourtOptions = CustomOption.AddHeader("<color=#2294E6>KingsCourt Mod Options:</color>");
